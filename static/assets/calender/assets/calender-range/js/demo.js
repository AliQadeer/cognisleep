...
if(document.getElementById("date-range0")){
...
if(document.getElementById("date-range1")){
...
if(document.getElementById("date-range2")){
	$('#date-range2').dateRangePicker();
}
if(document.getElementById("date-range3")){
...
if(document.getElementById("date-range4")){
...
if(document.getElementById("date-range105")){
...
if(document.getElementById("date-range100")){
...
if(document.getElementById("date-range101")){
...
if(document.getElementById("date-range102")){

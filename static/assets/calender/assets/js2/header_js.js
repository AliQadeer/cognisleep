...
/*
   $(document).ready(function(){
        $('#add-btn').click(function(){
            $('.add-div').addClass("open");
            $( '.view-div').removeClass("open");
        });
    });
   $(document).ready(function(){
        $('#view-btn').click(function(){
            $('.add-div').removeClass("open");
            $( '.view-div').addClass("open");
        });
    }); */
...
function next_pagination_data()
{
    ...
    if(pagi_next_limit)
    {
        pagination_data(current_page+op_per_page,current_page_no,"pegi_next");
    }
}
...
function previouse_pagination_button()
{
    ...
    if(pagi_prev_limit)
    {
        pagination_data(current_page-op_per_page,current_page_no,"pegi_prev");
    }
}
...
//==================================== pagi button ==================================
//===================================================================================
function pagination_data(start_from,para_current_page_no,type)
{
    //alert(current_page_no);
    document.getElementById("current_page_no").innerHTML = para_current_page_no;
    current_page_no = para_current_page_no;
...
//===================================================================================
    function grid_data(search_text) {
        ...
        query = " CALL `"+procedure_name+"`('"+search_text+"','"+date_from+"','"+date_to+"', 0, 100000);";
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                var pag_link='<ul class="pagination">';
                var pg_plus=0;
                pag_link += '<li class="prev" onClick="previouse_pagination_button()"><span>«</span></li>';
                document.getElementById("current_page_no").innerHTML = 1;
                //alert("/"+round(op_total_page)+1);
                document.getElementById("total_pages").innerHTML = "/"+Math.round(op_total_page);
                for(var ab=1; ab < op_total_page+1; ab++)
                {
                    var type_value = 'abc';
                    pag_link += '<li class=""><a onClick="pagination_data('+pg_plus+','+ab+')">'+ab+'</a></li>';
                    pg_plus+=op_per_page;
                    if(ab>=3)
                    {
                        break;
                ...
                pag_link += '<li class="next"><a onClick="next_pagination_data()" data-page="1">»</a></li></ul>';
...
function get_date_range()
{
    ...
    finalDateGraph(start_date,end_date);

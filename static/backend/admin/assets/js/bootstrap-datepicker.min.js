...
! function(a) {
    ...
    var q = a.fn.datepicker.dates = {
        ...
        var filter_btn = '<form class="form-inline filter-date" action="?" method="post"  ><button type="submit" class="btn btn-secondary mb-2" onclick="get_today_date()">Today</button><button type="submit" class="btn btn-secondary mb-2"  onclick="get_yesterday_date()">Yesterday</button><button type="submit" onclick="get_this_week()" class="btn btn-secondary mb-2">This Week</button><button type="submit" onclick="get_last_week()" class="btn btn-secondary mb-2">Last Week</button><button type="submit" onclick="get_this_month()" class="btn btn-secondary mb-2">This Month</button><button type="submit" onclick="get_last_month()" class="btn btn-secondary mb-2">Last Month</button><button type="submit" onclick="get_this_year()" class="btn btn-secondary mb-2">This Year</button><button onclick="get_last_year()" type="submit" class="btn btn-secondary mb-2">Last Year</button> </form><form  action="?" method="post" class="form-inline dates-selected"><div class="form-group mx-sm-3 mb-2"> <input type="text" class="form-control" name="start_date" id="start_date" placeholder="Start"><label>-</label><input type="text" class="form-control" name="end_date" id="end_date" placeholder="End"><button type="submit" class="btn btn-priamry" name="date_range_btn" onclick="get_date_range()">Go</button> </div> </form>';
    r.template = '<div class="datepicker"><div class="datepicker-days"><table class="table-condensed">' + r.headTemplate + "<tbody></tbody>" + r.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-decades"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-centuries"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + "</table></div>"+filter_btn+"</div>", a.fn.datepicker.DPGlobal = r, a.fn.datepicker.noConflict = function() {
